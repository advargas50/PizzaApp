...
/**
 * A subclass of pizza that creates a pizza of bbqchicken style, either Chicago or New York
...
public class BBQChicken extends Pizza{
    ...
    /**
     * The parameterized constructor of the bbq chicken pizza
    ...
    public String toString() {
        return " BBQChicken (" + size + ", " + crust + ") with toppings " + toppings;
    }
}
