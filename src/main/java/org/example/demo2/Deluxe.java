...
/**
 * A subclass of pizza that creates a pizza of deluxe style, either Chicago or New York
...
public class Deluxe extends Pizza{
    ...
    /**
     * The parameterized constructor of the deluxe pizza
    ...
    public String toString() {
        return " Deluxe (" + size + ", " + crust + ") with toppings " + toppings;
    }
}
